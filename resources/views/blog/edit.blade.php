                ...
                <div class="col-lg-9">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            value="{{ old('title', $blog->title) }}" placeholder="Tiêu đề" required>
                    </div>
                    <div class="mb-3">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status" name="status" required>
                            <option value="1" {{ $blog->status == 1 ? 'selected' : '' }}>Đã xuất bản</option>
                            <option value="0" {{ $blog->status == 0 ? 'selected' : '' }}>Bản nháp</option>
                        </select>
                    </div>

                    <div class="mb-3">
                        <label for="featured_image" class="form-label">Ảnh đại diện</label>
                        <input type="hidden" id="featured_image" name="featured_image" class="form-control"
                            aria-label="Image" aria-describedby="ckfinder-button" value="{{ $blog->featured_image }}">
                        <img id="image-preview"
                            src="{{ $blog->featured_image ? asset($blog->featured_image) : asset('storage/images/default-image.png') }}"
