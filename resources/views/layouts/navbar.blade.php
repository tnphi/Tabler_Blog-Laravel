            ...
            <ul class="navbar-nav pt-lg-3">
                    ...
                    <div class="dropdown-menu show">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ Request::is('blog/create') ? 'active' : '' }}"
                                ...
                                <a class="dropdown-item {{ Request::is('blog_categories') ? 'active' : '' }}"
                                    href="{{ route('blog_categories.index') }}">
                                    Chuyên mục
                                </a>
                                <a class="dropdown-item {{ Request::is('blog_tags') ? 'active' : '' }}"
                ...
                <li class="nav-item active dropdown">
                    ...
                    <div class="dropdown-menu show">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ Request::is('timeoff/create') ? 'active' : '' }}"
                                    href="{{ route('dayoff.create') }}">
                                    Xin nghỉ phép
                                </a>
                                <a class="dropdown-item {{ Request::is('timeoff') ? 'active' : '' }}"
